...
{
  private static final ud<String, String> a = new ud();
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      String str2 = Gq.a(paramContext).b(str1).toString();
      return str2;
    }
  ...
  public static String a(Context paramContext, int paramInt)
  {
    ...
    if (paramInt != 1)
    {
      if (paramInt != 2)
      {
        ...
        return paramContext.getString(Yp.common_google_play_services_enable_button);
      }
      return paramContext.getString(Yp.common_google_play_services_update_button);
    }
    return paramContext.getString(Yp.common_google_play_services_install_button);
  }
  ...
  private static String a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (paramString1 == null) {
      paramContext = localResources.getString(k.common_google_play_services_unknown_issue);
    }
  ...
  {
    return paramContext.getResources().getString(Yp.common_google_play_services_notification_channel_name);
  }
  ...
  public static String b(Context paramContext, int paramInt)
  {
    ...
    if (paramInt != 1)
    {
      if (paramInt != 2)
      {
            ...
            if (paramInt != 7)
            {
              if (paramInt != 9)
              {
                if (paramInt != 20)
                {
                  ...
                  {
                  default: 
                    return localResources.getString(k.common_google_play_services_unknown_issue, new Object[] { str });
                  case 18: 
                    return localResources.getString(Yp.common_google_play_services_updating_text, new Object[] { str });
                  case 17: 
              ...
              return localResources.getString(Yp.common_google_play_services_unsupported_text, new Object[] { str });
            }
        ...
        return localResources.getString(Yp.common_google_play_services_enable_text, new Object[] { str });
      }
      if (i.d(paramContext)) {
        return localResources.getString(Yp.common_google_play_services_wear_update_text);
      }
      return localResources.getString(Yp.common_google_play_services_update_text, new Object[] { str });
    }
    return localResources.getString(Yp.common_google_play_services_install_text, new Object[] { str });
  }
  ...
  public static String d(Context paramContext, int paramInt)
  {
    ...
    if (paramInt == 6) {
      ...
      str1 = e(paramContext, paramInt);
    }
    String str2 = str1;
    if (str1 == null) {
      str2 = paramContext.getResources().getString(Yp.common_google_play_services_notification_ticker);
    }
    return str2;
  }
  ...
  public static String e(Context paramContext, int paramInt)
  {
    ...
    case 18: 
      return null;
    case 3: 
      return localResources.getString(Yp.common_google_play_services_enable_title);
    case 2: 
      return localResources.getString(Yp.common_google_play_services_update_title);
    }
    return localResources.getString(Yp.common_google_play_services_install_title);
  }
}


/* Location:              /Applications/dex2jar/classes-dex2jar.jar!/com/google/android/gms/common/internal/e.class
