...
public class tc
{
  ...
  private static void a(String paramString, int paramInt, tc.a parama)
  {
    parama.b = false;
    int i = paramInt;
    int j = 0;
  ...
  private static void a(ArrayList<tc.b> paramArrayList, char paramChar, float[] paramArrayOfFloat)
  {
    paramArrayList.add(new tc.b(paramChar, paramArrayOfFloat));
  }
  
  public static boolean a(tc.b[] paramArrayOfb1, tc.b[] paramArrayOfb2)
  {
  ...
  public static tc.b[] a(String paramString)
  {
    if (paramString == null) {
      return null;
    }
    ...
    return (tc.b[])localArrayList.toArray(new tc.b[localArrayList.size()]);
  }
  
  public static tc.b[] a(tc.b[] paramArrayOfb)
  {
    if (paramArrayOfb == null) {
      return null;
    }
    tc.b[] arrayOfb = new tc.b[paramArrayOfb.length];
    for (int i = 0; i < paramArrayOfb.length; i++) {
      arrayOfb[i] = new tc.b(paramArrayOfb[i]);
    }
    return arrayOfb;
  }
  ...
  public static Path b(String paramString)
  {
    ...
    if (localObject != null) {
      try
      {
        tc.b.a((tc.b[])localObject, localPath);
        return localPath;
      }
  ...
  public static void b(tc.b[] paramArrayOfb1, tc.b[] paramArrayOfb2)
  {
  ...
  private static float[] c(String paramString)
  {
    if ((paramString.charAt(0) != 'z') && (paramString.charAt(0) != 'Z')) {
      try
      {
        ...
        Object localObject2 = new tc$a;
        ((tc.a)localObject2).<init>();
        int i = paramString.length();
        int j = 1;
        int k = 0;
        while (j < i)
        {
          a(paramString, j, (tc.a)localObject2);
          int m = ((tc.a)localObject2).a;
          int n = k;
          if (j < m)
          {
        ...
        localObject2 = a((float[])localObject1, 0, k);
...
/* Location:              /Applications/dex2jar/classes-dex2jar.jar!/tc.class
