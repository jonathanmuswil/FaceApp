...
public final class gfa
{
  ...
  public boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof gfa))
      {
        paramObject = (gfa)paramObject;
        if ((oXa.a(this.id, ((gfa)paramObject).id)) && (oXa.a(this.user_id, ((gfa)paramObject).user_id)) && (oXa.a(this.url, ((gfa)paramObject).url)))
        {
          int i;
          if (this.jdField_public == ((gfa)paramObject).jdField_public) {
            i = 1;
          } else {
            i = 0;
          }
          if ((i != 0) && (oXa.a(this.image, ((gfa)paramObject).image)))
          {
            if (this.image_width == ((gfa)paramObject).image_width) {
              i = 1;
            } else {
              i = 0;
            }
            if (i != 0)
            {
              if (this.image_height == ((gfa)paramObject).image_height) {
                i = 1;
              } else {
                i = 0;
              }
              if ((i != 0) && (oXa.a(this.created, ((gfa)paramObject).created)) && (oXa.a(this.votes, ((gfa)paramObject).votes)))
              {
                if (this.votes_total == ((gfa)paramObject).votes_total) {
                  i = 1;
                } else {
                  i = 0;
                }
                if ((i != 0) && (oXa.a(this.votes_counts, ((gfa)paramObject).votes_counts)) && (oXa.a(this.my_vote, ((gfa)paramObject).my_vote)))
                {
                  if (this.is_bookmarked == ((gfa)paramObject).is_bookmarked) {
                    i = 1;
                  } else {
                    i = 0;
                  }
  ...
  public int hashCode()
  {
    ...
    int i9 = this.is_bookmarked;
    int i10 = i9;
    if (i9 != 0) {
      i10 = 1;
    }
    return (((((((((((j * 31 + k) * 31 + m) * 31 + i2) * 31 + i1) * 31 + i3) * 31 + i4) * 31 + i5) * 31 + i6) * 31 + i7) * 31 + i8) * 31 + i) * 31 + i10;
  }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("Poll(id=");
...
/* Location:              /Applications/dex2jar/classes-dex2jar.jar!/gfa.class
