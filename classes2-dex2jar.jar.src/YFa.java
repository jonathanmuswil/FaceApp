...
{
  public static final yFa a = new yFa();
  ...
  public final Bitmap a(List<? extends Uri> paramList)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (localObject1 != null)
      {
        ...
        Bitmap localBitmap = Bitmap.createBitmap(j * 2, k * 2, Bitmap.Config.ARGB_8888);
        ...
        while (paramList.hasNext())
        {
          ...
          if (i >= 0)
          {
            ...
            if (localObject4 != null)
            {
              ...
              float f3 = k;
              ((Matrix)localObject1).postScale(f2, f3 / ((Bitmap)localObject4).getHeight());
              if (i % 2 == 0) {
                f1 = 0.0F;
              }
              if (i < 2) {
              ...
              ((Matrix)localObject1).postTranslate(f1, f3);
              ((Canvas)localObject3).drawBitmap((Bitmap)localObject4, (Matrix)localObject1, (Paint)localObject2);
...
/* Location:              /Applications/dex2jar/classes2-dex2jar.jar!/yFa.class
